			      ...
			      <ul class="nav navbar-nav">
			        ...
			        <li class="dropdown">
			          ...
			          <ul class="dropdown-menu" role="menu">
			            ...
			            <li class="divider"></li>
			            <li><a href="registros/prod.php">Inventario</a></li>
			       ...
			       <li class="dropdown">
			          ...
			          <ul class="dropdown-menu" role="menu">
			            <li><a href="documentos/factura.php">Facturas</a></li>
			            <li><a href="documentos/cotizar/cotizacion.php">Cotizaciones</a></li>			       
 			            <li><a href="documentos/pedidos/pedidos.php">Pedidos</a></li>
			          </ul>
			        </li>
