...
<body>
	...
	<div class="container">
  	  ...
  	  <div class="col-md-4">
 	  	<h2 style="color: rgb(0, 15, 128);">Archivo - Clientes</h2>
 	  </div>
		
		<table width="100%" class="table table-bordered table-hover" id="table_id">
	        <thead>
	            <tr style="background: rgba(60, 60, 60, 0.31);">
	                <th width="auto">#</th>
				...
				for($j=0; $j<sizeof($arrayCliente); $j++)
	        		{
	        			echo '
	        				<tr>
			        			...
			        			echo '<td><a href="edit.php?id='.$arrayCliente[$j]['idcliente'].'&n=1"><img src="../images/edit.png"/> </a>
			        			<a href="delete.php?id='.$arrayCliente[$j]['idcliente'].'&n=1" onclick="return confirmation()"><img src="../images/deleteu.png"/></a></td>
	        			    </tr>';
        		}
			}
			 ?>
