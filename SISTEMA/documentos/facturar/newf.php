...
<!-- 				<?php #include('editProductoFactura.php'); ?>
 -->
	        ...
	        <form name="facturar" id="facturar" action="../../process.php" method="post" >
        		<input type="hidden" size="1" readonly name="action" id="action" value="facturar"/>
        		<input type="hidden" size="1" readonly name="idF" id="idF" value="<?php echo $idF; ?>"/>
        		<input type="hidden" size="1" readonly name="tipo" id="tipo" value="<?php echo $tipo; ?>"/>
            	...
            	<div class="panel panel-default">
					...
					<input type="hidden" size="1" readonly name="stockN" id="stockN" />
				<?php
					$stockN = $form->error("stockN");
					if($stockN!="")
					{
					echo '<span class="text-error-field">&nbsp;'.$stockN.'&nbsp;&nbsp;&nbsp;</span>';
					}
				?>
...
-->				    <button id="guardar" type="submit" name="guardar" class="ag btn btn-primary btn-lg" value="guardar"><img src="../../images/save.png"/> Guardar</button>
			   ...
			   <script type="text/javascript">
					...
					function fnc1()
					{
					    var a=window.location.href;
					 	...
					 	var date = document.facturar.fecha.value;
	...
	<script>
		...
		// 		idf='<?php echo $idF;?>';
		// 		n='<?php echo $tipo;?>';
		// 		var fac_id = $(this).attr('data-pid');
		// 		var t = this.value;
		// 		var href = "editProductoFactura.php?d="+fac_id+"&dd="+t+"&idf="+idf+"&n="+n;

		// 			$('#div-edit').load(href,null, function() {
		// 				$('#loader1').hide();
