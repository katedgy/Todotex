...
<!-- 				<?php #include('editProductoFactura.php'); ?>
 -->
	        ...
	        <form name="cotizar" id="cotizar" action="../../process.php" method="post" >
        		<input type="hidden" size="1" readonly name="action" id="action" value="cotizar"/>
            	...
            	<div class="panel panel-default">
					<div class="panel-heading"><h3>Cotizacion N°:000<?php echo $idc;?></h3></div>
						...
						<div class="row2">
							...
							<br/><br/>
							<div class="col-md-4">
				                <input class="form-control" placeholder="Att" type="text" name="att" id="att" value="<?php echo $form->value("att"); ?>"/>
								<?php
